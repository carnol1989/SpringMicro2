...
public class MenuServiceImpl implements IMenuService {
	...
	@Override
	public Menu registrarService(Menu obj) {
		return repo.save(obj);
	}

	@Override
	public Menu modificarService(Menu obj) {
		return repo.save(obj);
	}

	@Override
	public List<Menu> listarService() {
		return repo.findAll();
	}

	@Override
	public Menu leerPorIdService(Integer id) {
	...
	@Override
	public List<Menu> listarMenuPorUsuarioService(String nombre) {
